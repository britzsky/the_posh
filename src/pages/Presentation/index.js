    ...
    <>
      ...
      >
        <img
          src={companyImage2}
          alt="Bottom Banner"
          style={{ width: "70%", height: "auto", maxWidth: "850px" }}
        />
        <MKBox
          position="absolute"
          top="50%"
      ...
      <MKBox
        ...
        width="100%"
        py={12}
        sx={{ backgroundColor: "#fff", display: "grid", placeItems: "center" }}
      >
        <Container>
            ...
            {[
              {
                img: sol_subImage1,
                title: "1. 정기적 현지 방문",
                desc: `정기적인 현지 방문으로 공장의 긴장도를 높여 품질을 유지하고,
      꾸준한 관계를 구축하여 안정적인 생산 기반을 확보합니다.`,
              },
              {
                img: sol_subImage2,
                title: "2. 생산 현장 직접 관리",
                desc: `메인 물량 생산 시, 직접 공장을 방문하여 샘플과 동일한 제품이
      생산되는지 철저히 확인합니다. 이를 통해 제품의 일관성을 확보하고
      불량 발생을 사전에 방지합니다.`,
              },
              {
                img: sol_subImage3,
                title: "3. 불량품 관리 보상",
                desc: `불량품 발생 시, 중국 공장과 협의하여 합리적이고 적절한 보상을
      제공합니다. 신속한 문제 해결로 고객사의 손실을 최소화하고 신뢰를
      지킵니다.`,
              },
            ].map((item, idx) => (
              <Grid
                ...
                container
                spacing={4}
                direction={idx % 2 === 1 ? "row-reverse" : "row"} // 짝수는 row, 홀수는 row-reverse
                alignItems="center"
                justifyContent="center"
                mb={6}
              >
                ...
                >
                  ...
                  >
                    <MKTypography variant="h6" fontWeight="bold" gutterBottom>
                      {item.title}
                    </MKTypography>
        ...
        <Container>
          <Card
            sx={{
              ...
              borderImageSlice: 1,
              borderImageSource:
                "linear-gradient(90deg, #27548A 0%, #183B4E 100%)",
            }}
          >
            <MKTypography
              variant="h4"
            ...
            <Grid container spacing={4} justifyContent="center">
              {[
                { img: productImage1, title: "유리섬유 직물(준불연)" },
                { img: productImage2, title: "메쉬(Glass, PET, Cotton)" },
              ].map((p, idx) => (
            ...
            <Grid container spacing={4} justifyContent="center">
              {[
                { img: productImage3, title: "부직포(PET, PP, PLA 등)" },
                { img: productImage4, title: "지오그리드(Glass, PET, PP)" },
              ].map((p, idx) => (
                <Grid item xs={12} md={6} key={idx} textAlign="center">
                  <MKBox mb={2}>
                    <img
